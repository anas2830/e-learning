        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.courseAddClass.update', [$class->id])}}" method="POST">
                ...
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        <label for="class_resource" class="control-label col-lg-3">Class Resource <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <textarea id="class_resource" name="class_resource" class="form-control" required="required">{{$class->class_resource}}</textarea>
                        </div>
                    </div>
