...
<form class="form-horizontal form-validate-jquery" action="{{route('applyAvailableAssignment')}}" method="POST">
    @csrf
    <fieldset class="content-group">
        ...
        <div class="form-group">
            <label class="control-label col-lg-4">Number Of Assignments [Limit 5]<span class="text-danger">*</span></label>
            <div class="col-lg-8">
                {{-- <input type="number" name="number_of_assignment" min="1" class="form-control" required="required" placeholder="taken assignment"> --}}
                <input type="range" name="number_of_assignment" value="1" step="1" min="1" max="5" required="required">
            </div>
        </div>
        <!-- /basic text input -->
