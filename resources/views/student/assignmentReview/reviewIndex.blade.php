            ...
            <div class="navbar navbar-default navbar-xs">
                ...
                <div class="navbar-collapse collapse" id="navbar-second-toggle">
                    <ul class="nav navbar-nav" id="review_sub_menu">
                        ...
                        <li><a href="reviewInstruction">Instruction</a></li>
                        <li class="active"><a href="assignmentDetails">Assignment</a></li>
                        <li><a href="assignmentDiscussion">Comments</a></li>
                    </ul>
                    <a href="{{route('availableAssignment')}}" class="btn border-teal-400 text-teal btn-flat btn-rounded btn-icon btn-xs ml-15"><i class="icon-undo2"></i> All Taken Assignment</a>
                </div>
            </div>
            <!-- /second navbar -->
        </div>
