...
<div class="content @if (@$student_course_info->is_freez == 1) lfwf-freez-content @endif">
    ...
    <div class="slider-container">
            ...
            <div class="slider-item">
                <div class="slider-content">
                    <div class="slider-top">
                        <img src="https://i.ibb.co/Htzchkr/success.jpg" alt="">
                    ...
                    <div class="slider-mid">
                        <div class="slider-left">
                            <div class="left-thumb">
                                <img src="https://i.ibb.co/f2Cp6T4/facebook-profile-pic.jpg" alt="">
                            </div>
                            <div class="left-student-info">
                                <h2 class="slider-student-name">Jillur Rahman</h2>
                                <h5 class="slider-course-name">Web Design & Development</h5>
                                <h3 class="slider-batch-name">Batch-15</h3>
                            </div>
                        </div>
                        <div class="slider-right">
                            <h3 class="marketplace-name">Fiverr</h3>
                            <h4 class="job-ammount">$50.00</h4>
                        </div>
                    </div>
                    <div class="slider-bottom">
                        <p> <span>"</span> It works like magic after just one use. I love this product so much <span>"</span></p>
                    </div>
                </div>
            </div>
        ...
        <div class="slider-read-more">
            <a href="#">
                <ul>
                    <li> <img src="https://avatars.githubusercontent.com/u/286616?s=64&v=4" alt=""> </li>
                    <li> <img src="https://avatars.githubusercontent.com/u/1820514?s=64&v=4" alt=""> </li>
                    <li> <img src="https://avatars.githubusercontent.com/u/3287153?s=64&v=4" alt=""> </li>
                    <li> <img src="https://avatars.githubusercontent.com/u/5685445?s=64&v=4" alt=""> </li>
                    <li> <img src="https://avatars.githubusercontent.com/u/2623646?s=64&v=4" alt=""> </li>
                    <li> <img src="https://avatars.githubusercontent.com/u/286616?s=64&v=4" alt=""> </li>
                    <li> <img src="https://avatars.githubusercontent.com/u/1820514?s=64&v=4" alt=""> </li>
                    <li> <img src="https://avatars.githubusercontent.com/u/3287153?s=64&v=4" alt=""> </li>
                    <li> <img src="https://avatars.githubusercontent.com/u/5685445?s=64&v=4" alt=""> </li>
